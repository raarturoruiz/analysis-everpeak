...
El dataset `everpeak_retail` incluye 5,000 órdenes de clientes con valores faltantes, sentinels, outliers y problemas de calidad diseñados para simular datos reales del retail. :contentReference[oaicite:2]{index=2}
...
[![Open In Colab]([https://colab.research.google.com/assets/colab-badge.svg](https://github.com/raarturoruiz/analysis-everpeak/blob/main/Analysis_Everpeak.ipynb))](URL_DEL_NOTEBOOK_EN_GITHUB)
